<!-- https://wpthemesgrid.com/themes/eshop/shop-grid.html -->
<?php get_header('shop');?>
               ...
               <div class="single-widget category">
                  ...
                  <ul class="categor-list">
                        ...
                        $product_categories = get_terms( array(
                           ...
                           'hide_empty' => true, // Set to true if you only want to fetch categories with products
                        ) );
                        ...
                        if ( ! empty( $product_categories ) && ! is_wp_error( $product_categories ) ) {
                           ...
                           foreach ( $product_categories as $category ) {
                              ...
                              echo '<li><a href="' . get_term_link( $category ) . '">' . $category->name . '</a>('.$product_count.')</li>';
                           }
                        } else {
        ...
        <div class="col-lg-9 col-md-8 col-12">
            <div class="row">
                ...
                <div class="shop-top">
                     ...
                     <ul class="view-mode">
                        <li class="active"><a href="shop-grid.html" previewlistener="true"><i class="fa fa-th-large"></i></a></li>
                        <li><a href="shop-list.html" previewlistener="true"><i class="fa fa-th-list"></i></a></li>
                     </ul>
                  </div>
                </div>   
            </div>
